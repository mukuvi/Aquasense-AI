    ...
    if (selectedImage) {
      try {
        const newPublication = {
          title: newPublicationTitle || "New publication", // Uses the entered title or a default title
          imageSource: { uri: selectedImage }, // Selected image
          views: 0,
          likes: 0,
          shares: 0,
        };
        ...
        setNewPublicationTitle(""); // Reset the new publication title
        Alert.alert("Success", "The image has been shared successfully!");
      } catch (error) {
